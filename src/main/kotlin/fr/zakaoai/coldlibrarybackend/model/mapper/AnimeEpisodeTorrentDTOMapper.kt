...
fun AnimeEpisodeTorrentDTO.toModel(idAnimeEpisode: Long) = AnimeEpisodeTorrent(null,title,date,torrentLink, torrentId, torrentSize, seeders, leechers, completed, idAnimeEpisode, malId)